...
describe("Click Component Events tests", () => {
  ...
  it("Should click outside the component, closing menu - Autocomplete", () => {
    ...
    //closed
   expect(component.find(".input-box").html()).toEqual(
      '<div class=\"input-box\"><div class=\"input-container\" style=\"width: 200px;\"><div class=\"rbc-2b097c-container \"><div class=\"rbc-13srbr-control \"><div class=\"rbc-1hwfws3\"><div class=\"rbc-b8ldur-Input\"><input id=\"rbc-13sxxr-input-1234978\" class=\"rbc-13sxxr-input\" placeholder=\"Search...\" type=\"search\" style=\"box-sizing: content-box; width: 90%; background: center; border: 0px; font-size: inherit; opacity: 1; outline: 0px;\" autocomplete=\"off\" value=\"\"></div></div></div></div><div class=\"dropdown-menu \"><div class=\"rbc-padding-left20 noselect\">No items</div></div></div></div>'
    );
